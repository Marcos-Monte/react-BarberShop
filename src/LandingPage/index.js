...
export default function LandingPage() {
    return (
        <div className="body">
            <header>
                <div className="largura-pagina">
                    <img src="assets\barbearia-logo.png" alt="Logotipo da BarberShop" />
                    <button>
                        <img src="assets\moon.png" alt="Simbolo de Sol / Lua para auxiliar a mudança entre Light e Darg" />
                        <span>Dark</span>
                    </button>
                </div>
            </header>
